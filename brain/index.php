...
<div class="input-group">
 <div class="input-group-btn input-group-sm">
   <button type="button" class="btn btn-default" onclick="document.location.href='indexon.php';" id="localcopy" style="display:none" ><span class="glyphicon glyphicon-open" style="color: red" ></span>&nbsp;</button>
   <button type="button" class="btn btn-default" onclick="document.location.href='indexon.php';" id="webcopy" ><span class="glyphicon glyphicon-open" style="color: green"></span>&nbsp;</button>
