...
<html lang="en" manifest="brainmain_appcache.php" >
   <!-- ==========================
    	Meta Tags 
    =========================== -->
	...
	<script>
	var modo="online"; // "online";
	function handleCacheError(){
	 //document.location.href="indexoff.php";
	}
   ...
   function updateIndicator() {
    ...
    applicationCache.addEventListener('obsolete', handleCacheError, false);
...
<div class="input-group">
 <div class="input-group-btn input-group-sm">
     <button type="button" class="btn btn-default" onclick="document.location.href='index.php';" id="localcopy" style="display:none" ><span class="glyphicon glyphicon-cloud-download" style="color: red" ></span>&nbsp;</button>
